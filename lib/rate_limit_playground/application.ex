defmodule RateLimitPlayground.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      RateLimitPlaygroundWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: RateLimitPlayground.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    RateLimitPlaygroundWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
